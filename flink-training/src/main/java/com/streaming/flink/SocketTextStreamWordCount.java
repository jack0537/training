                        ...
                        .apply(
                                new WindowFunction<HashMap<String, String>, Tuple2<String, String>, Object, TimeWindow>() {
                                    ...
                                    public void apply(Object o, TimeWindow timeWindow, Iterable<HashMap<String, String>> iterable, Collector<Tuple2<String, String>> collector) throws Exception {
                                        ...
                                        String windowStart = format.format(Long.valueOf(timeWindow.getStart()));
                                        String windowEnd = format.format(Long.valueOf(timeWindow.getEnd()));
                                        System.out.println("this window is fired:" + timeWindow + "  start=" + windowStart + "  end=" + windowEnd);
                                        for (HashMap map : iterable) {
                                            String d = format.format(Long.valueOf(map.get("timestamp").toString()));

                                            System.out.println("this fired has element:" + map.get("timestamp") + "   format=" + d);
                                        }
                                    }
                                }).setParallelism(1);
